    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pullToRefreshView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                fTypes = 0;
                fromIds = firstId;callClient(fTypes, fromIds);
            }
        ...
        String jsonString = com.droid108.tweetrap.Helpers.SPF.GetSharedPreference(R.string.spf_news_tweets, rootView.getContext());
