...
public class LicenseFragment extends DialogFragment {
    ...
    private static final String FRAGMENT_TAG = "com.android.tweetrap.LicensesFragment";
     ...
     * @return A new licenses fragment.
     */
    public static LicenseFragment newInstance(boolean showCloseButton) {
    ...
    public static void displayLicensesFragment(FragmentManager fm) {
        ...
        DialogFragment newFragment = LicenseFragment.newInstance();
    ...
    public static void displayLicensesFragment(FragmentManager fm, boolean showCloseButton) {
        ...
        // Create and show the dialog.
        DialogFragment newFragment = LicenseFragment.newInstance(showCloseButton);
        newFragment.show(ft, FRAGMENT_TAG);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View content = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_license, null);
    ...
    private void loadLicenses() {
        ...
        mLicenseLoader = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                InputStream rawResource = getActivity().getResources().openRawResource(R.raw.open_source_licenses);
