...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_science, container, false);

        AdView mAdView = (AdView) rootView.findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        //adRequest.isTestDevice(this);
        mAdView.loadAd(adRequest);
        pullToRefreshView = (PullToRefreshListView) rootView.findViewById(R.id.pull_to_refresh_listview_science);
        ...
        String jsonString = SPF.GetSharedPreference(R.string.spf_science_tweets, rootView.getContext());
...
//        });
    ...
    private void callClient(int fType, int fromId) {
        ...
        if (!isRefreshinProgress) {
            ...
            _client.execute("http://com.droid108.tweetrap.elasticbeanstalk.com/api/catscience?ftype=" + fType + "&fromid=" + fromId);
