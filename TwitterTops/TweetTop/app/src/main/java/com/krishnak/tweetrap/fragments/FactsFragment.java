...
public class FactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_facts, container, false);
        ...
        String jsonString = SPF.GetSharedPreference(R.string.spf_facts_tweets, rootView.getContext());
