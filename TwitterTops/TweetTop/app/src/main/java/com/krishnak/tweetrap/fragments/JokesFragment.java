...
public class JokesFragment extends Fragment {
    ...
    com.droid108.tweetrap.Adapter.TweetAdapter madapter;
    View rootView;
    int fTypes = 0;
    int fromIds = 0;
    int lastId = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String jsonString = com.droid108.tweetrap.Helpers.SPF.GetSharedPreference(R.string.spf_jokes_tweets, rootView.getContext());
...
//        });
    ...
    private void callClient(int fType, int fromId) {
        ...
        if (!isRefreshinProgress) {
            ...
            _client.execute("http://tweetrap.elasticbeanstalk.com/api/catjokes?ftype=" + fType + "&fromid=" + fromId);
